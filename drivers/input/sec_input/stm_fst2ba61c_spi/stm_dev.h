...
#define SEC_INPUT_NOTIFY_MAX_QUEUE	16
#endif
...
struct stm_ts_data {
	...
	int code_version_of_ic;			/* firmware version of IC */
	int code_version_of_bin;			/* firmware version of binary */
...
#endif
#if IS_ENABLED(CONFIG_INPUT_SEC_NOTIFIER)
	struct delayed_work input_notify_work;
	struct kfifo input_notify_fifo;
	struct mutex input_notify_mutex;
	bool is_input_notify_ready;
#endif
