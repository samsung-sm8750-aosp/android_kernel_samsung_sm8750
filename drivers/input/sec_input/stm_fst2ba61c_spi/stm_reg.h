...
#define STM_TS_CMD_FUNCTION_SET_FAST_RESPONSE		0x16
#define STM_TS_CMD_FUNCTION_SET_VIRTUAL_VOLUME_CONTROL	0x17
...
#define STM_TS_GESTURE_CODE_AOD_NOTI_RECT	0x09
